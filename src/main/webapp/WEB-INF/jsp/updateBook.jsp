...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/updateBook" method="post">
        ...
        <input type="hidden" name="bookId" value="${books.getBid()}"/>
        书籍名称：<input type="text" name="bookName" id="bookName" value="${books.getBname()}"/>
        作者：<input type="text" name="bookAname" id="bookAname" value="${books.getAname()}"/>
        书籍描述：<input type="text" name="bookBdescribe" id="bookBdescribe" value="${books.getBdescribe()}"/>
        书籍类型：<input type="text" name="bookTname"  id="bookTname" value="${books.getTname()}"/>
